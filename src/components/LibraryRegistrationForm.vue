  ...
  <div class="container mt-5">
    <form @submit.prevent="submitForm">
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control" id="reason" rows="3" v-model="formData.reason" @input="validateReason"></textarea>
      ...
      <div class="mb-3">
        ...
        <div class="mt-2 text-muted">
          <strong>Note:</strong> The value of this field is bound with <code>v-bind</code>, so it will not reflect changes made in the form to the data.
        </div>
      </div>
